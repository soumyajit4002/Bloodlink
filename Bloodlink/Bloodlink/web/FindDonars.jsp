    ...
    <body>
        <div class="container">
            ...
            <%
                ...
                String currentUserEmail = (String) sess.getAttribute("email");  // ✅ Logged in user email
                ...
                try {
                    ...
                    // ✅ Exclude current logged-in user's own donation
                    rs = st.executeQuery(
                        "SELECT * FROM donations WHERE Bloodgroup='" + bg + 
                        "' AND Location='" + lo + 
